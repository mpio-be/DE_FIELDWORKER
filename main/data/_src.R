...
# HATCH DATE ESTIMATION
  x = dbq(
    q = 'SELECT nest, plot, found_datetime,initial_clutch_size, clutch_size,hatching_datetime,
          mean_float_height2 surface, mean_float_angle2 float_angle,
  ...
  x = x[!(is.na(float_angle) & initial_clutch_size == clutch_size)]
